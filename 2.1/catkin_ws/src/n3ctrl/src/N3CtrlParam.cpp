...
void Parameter_t::config_from_ros_handle(const ros::NodeHandle& nh)
{
	...
	read_essential_param(nh, "gain/hover/Kpd0", hover_gain.Kpd0);
	read_essential_param(nh, "gain/hover/Kpd1", hover_gain.Kpd1);
	read_essential_param(nh, "gain/hover/Kpd2", hover_gain.Kpd2);
	...
	read_essential_param(nh, "gain/hover/Kvd0", hover_gain.Kvd0);
	read_essential_param(nh, "gain/hover/Kvd1", hover_gain.Kvd1);
	read_essential_param(nh, "gain/hover/Kvd2", hover_gain.Kvd2);
	...
	read_essential_param(nh, "hover/hor_kp", hover.hor_kp);
	read_essential_param(nh, "hover/hor_kd", hover.hor_kd);
	read_essential_param(nh, "hover/hor_lower_limit", hover.hor_lower_limit);
	read_essential_param(nh, "hover/hor_higher_limit", hover.hor_higher_limit);
	...
	read_essential_param(nh, "hor_x_k", hor_x_k);
	read_essential_param(nh, "hor_y_k", hor_y_k);
	read_essential_param(nh, "full_thrust", full_thrust);
	read_essential_param(nh, "delta_hov_percent_threshold", delta_hov_percent_threshold);
	...
	nh.param("log_path", log_path, std::string("/home/chx/catkin_ws/log/"));
};
