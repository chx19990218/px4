...
//		std::cout<<"channel_out_of_deadzone"<<channel_out_of_deadzone[0]<<channel_out_of_deadzone[1]<<channel_out_of_deadzone[2]<<channel_out_of_deadzone[3];
        ...
        while (1) {
            if (axis_states[axis_id] == FIX) {
                ...
                if (velo_in_stop_range[axis_id])
								{
									//if(++stateChangeCnt[axis_id] > 100)//TODO:delete
									{
